						...
						<div class="accordion-content clearfix">
							<form id="login-form" name="login-form" class="row mb-0" action="LoginService" method="post">
								...
								<div class="col-12 form-group">
									...
									<a href="#" class="float-end">비밀번호를 잊으셨나요?</a>
								</div>
							</form>
						</div>
						...
						<div class="accordion-content clearfix">
							<form id="register-form" name="register-form" class="row mb-0" action="JoinService" method="post">
								...
								<div class="col-12 form-group">
									...
									<br>
									<label>
										<input style="transform : scale(1.3);" style="margin-top:7px;"type="radio" name="gender" value="M"><span style="font-size:large;">  Man</span>
									  </label>
									  <label>
										<input style="transform : scale(1.3);" style="margin-top:7px;"type="radio" name="gender" value="F"><span style="font-size:large;">  Woman</span>
									  </label>
								</div>
								...
								<div class="col-12 form-group">
									...
									<input type="password" id="login-form-password" name="nick" value="" class="form-control not-dark" />
								</div>
