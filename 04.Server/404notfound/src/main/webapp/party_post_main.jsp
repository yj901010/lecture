						...
						<div class="col-lg-8 col-xl-7">
							<div class="p-5 rounded-5 shadow-lg">
								<div class="d-flex flex-column flex-sm-row mb-4">
									...
									<div>
										<h3 class="mb-0"><%=mlist.get(party.getP_no()-1).getName() %></h3>
										<p style="margin-bottom:0px"><%=mlist.get(party.getP_no()-1).getTitle() %></p>
										<p><%=mlist.get(party.getP_no()-1).getPrice() %>원</p>
									</div>
