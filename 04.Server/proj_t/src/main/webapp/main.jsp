...
<body>
	<div id="wrap">
		...
		<a href="LogoutService"><div class="menu">로그아웃</div></a>
		<a href="postWrite.jsp"><div class="menu">게시글작성</div></a>
		<a href="partyCreate.jsp"><div class="menu">파티생성</div></a>
		<a href="party.jsp"><div class="menu">파티목록</div></a>
